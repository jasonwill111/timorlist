...
### US-1: Homepage
- [x] src/pages/index.astro uses Input, Button, Badge
- [ ] pnpm build exits 0
- [ ] GET / returns 200

### US-2: Search
- [x] src/pages/search.astro uses Input, Button, Badge
- [ ] pnpm build exits 0

### US-3: Business Detail
- [x] src/pages/business/[slug].astro uses Button, Badge, Avatar
- [ ] pnpm build exits 0

### US-4: Business Edit
- [x] src/pages/business/[slug]/edit uses Input, Tabs, Button
- [ ] pnpm build exits 0

### US-5: Product Pages
- [x] business/[slug]/product/* uses Input, Textarea, Button, Badge
- [ ] pnpm build exits 0
