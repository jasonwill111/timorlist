...
UPDATE non_profits SET 
  aboutUs = 'CARE International has been working in Timor-Leste since 1999, focusing on women's empowerment, food security, and emergency response. We work with local communities to create lasting change.',
...
UPDATE non_profits SET 
  aboutUs = 'World Vision Timor-Leste focuses on child well-being, working through area development programs in 6 municipalities. Our programs include education, health, and economic development.',
...
UPDATE non_profits SET 
  aboutUs = 'Plan International Timor-Leste operates in 8 municipalities, focusing on child protection, youth empowerment, and disaster risk reduction. We ensure children, especially girls, have access to quality education.',
...
UPDATE non_profits SET 
  aboutUs = 'Cruz Vermelha Timor-Leste (Timor-Leste Red Cross) provides humanitarian assistance, disaster response, and blood donation services. We are part of the world\'s largest humanitarian network.',
...
INSERT OR REPLACE INTO non_profits (id, title, slug, owner_id, category_id, status, aboutUs, contact_name, contact_number, country_code, email, address, location_lat, location_lng, tags, likes, saves, views, verified_badge, created_at, updated_at)
