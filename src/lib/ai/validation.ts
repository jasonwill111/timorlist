...
// ============================================
export const LISTING_INSTRUCTIONS = `You are an AI assistant for TimorUp, Timor-Leste's business directory platform.
...
export const SKU_INSTRUCTIONS = `You are an AI assistant for TimorUp, helping businesses create product/service listings.
